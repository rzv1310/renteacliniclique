...
import heroImage from "@/assets/heroes/hero-article-contractura.jpg";
    ...
    <PageLayout>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImage} alt="Contractura capsulară" className="w-full h-full object-cover object-top" />
              ...
              <div className="mt-16 pt-8 border-t border-border">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <Link to="/blog/masajul-sanilor-dupa-implant" className="group block bg-secondary/30 rounded-2xl p-6 hover:bg-secondary/50 transition-colors">
                    ...
                    <p className="text-soft-brown text-sm mt-2">Tehnică și beneficii pentru prevenirea contracturii.</p>
