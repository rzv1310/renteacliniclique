      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-soft-brown leading-relaxed max-w-2xl mx-auto mb-8">
      ...
      <section className="py-16 bg-gradient-soft">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-serif text-3xl font-semibold text-deep-brown mb-6">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={item} className="flex items-start gap-3 bg-champagne-light rounded-xl p-4">
                  <Check className="w-5 h-5 text-rose-gold shrink-0 mt-0.5" />
                  <span className="text-soft-brown">{item}</span>
                </div>
              ))}
              ...
              {[
                ...
                <div key={technique.name} className="bg-card rounded-xl p-6 shadow-soft">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                      <h3 className="font-serif text-xl font-semibold text-deep-brown mb-1">
                        {technique.name}
                      </h3>
                      <p className="text-soft-brown">{technique.desc}</p>
                    </div>
                    <span className="bg-champagne-light text-soft-brown text-sm px-4 py-2 rounded-full whitespace-nowrap">
                      {technique.severity}
                    </span>
                  </div>
                </div>
            ...
            <div className="grid sm:grid-cols-3 gap-4 text-left">
              {[
                ...
                <div key={item.time} className="bg-card rounded-xl p-5 shadow-soft">
                  <p className="font-serif text-lg text-rose-gold mb-1">{item.time}</p>
