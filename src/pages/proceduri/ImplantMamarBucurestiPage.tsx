...
import { ArrowRight, Check, Clock, Syringe, BedDouble, Diamond, ChevronDown, ZoomIn, X, Ruler, Phone } from "lucide-react";
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-3 gap-4 max-w-xl mx-auto mb-12">
              ...
              <div className="bg-card rounded-xl p-6 text-center border border-border/50">
                <BedDouble className="w-6 h-6 text-primary mx-auto mb-3" />
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Button size="lg" className="btn-glow-border bg-transparent text-white border border-rose-gold/60 hover:bg-rose-gold/10 hover:border-rose-gold" asChild>
              <a href="tel:+40740000000">
                <Phone className="w-5 h-5 mr-2" />
                Ești gata pentru <span className="text-primary font-handwriting text-3xl">cea mai bună versiune</span> a ta?
              </a>
            </Button>
          </div>
        </div>
