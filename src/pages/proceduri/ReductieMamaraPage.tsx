          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-card rounded-2xl p-8 shadow-soft">
                <h3 className="font-serif text-xl font-semibold text-deep-brown mb-6">
                  Beneficii Principale
                </h3>
                <ul className="space-y-4">
                  {benefits.map((benefit, index) => (
                    <li key={index} className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-rose-gold/20 flex items-center justify-center shrink-0 mt-0.5">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-card rounded-2xl p-8 lg:p-12 shadow-soft">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div>
                  <h3 className="font-semibold text-deep-brown mb-2">Prima săptămână</h3>
                  <p className="text-sm text-soft-brown">
                    Repaus la pat, sutien special, medicație pentru durere. Evitarea efortului fizic.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-deep-brown mb-2">Săptămânile 2-3</h3>
                  <p className="text-sm text-soft-brown">
                    Reluarea treptată a activităților ușoare. Controale pentru monitorizarea vindecării.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-deep-brown mb-2">După 4-6 săptămâni</h3>
                  <p className="text-sm text-soft-brown">
