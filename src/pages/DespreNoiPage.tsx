          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={stat.label} className="text-center">
                <p className="font-serif text-4xl lg:text-5xl text-rose-gold font-semibold mb-2">
                  {stat.value}
                </p>
                <p className="text-soft-brown text-sm">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={value.title} className="bg-champagne-light rounded-xl p-6">
                  <value.icon className="w-8 h-8 text-rose-gold mb-3" />
                  <h3 className="font-medium text-deep-brown mb-1">{value.title}</h3>
                  <p className="text-xs text-soft-brown">{value.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-soft">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="font-serif text-3xl md:text-4xl font-semibold text-deep-brown mb-12">
              Echipa Noastră
            </h2>

            <div className="bg-card rounded-2xl p-8 lg:p-12 shadow-elegant">
              <div className="w-32 h-32 rounded-full bg-champagne-light mx-auto mb-6 flex items-center justify-center">
                <span className="text-4xl">👩‍⚕️</span>
              </div>
              <h3 className="font-serif text-2xl font-semibold text-deep-brown mb-2">
                Dr. Maria Rentéa
              </h3>
              <p className="text-rose-gold mb-4">Chirurg Estetician Principal</p>
              <p className="text-soft-brown max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-soft-brown leading-relaxed mb-12 max-w-2xl mx-auto">
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              {[
                ...
                <div key={feature.title} className="bg-champagne-light rounded-xl p-6">
                  <h3 className="font-medium text-deep-brown mb-2">{feature.title}</h3>
                  <p className="text-sm text-soft-brown">{feature.desc}</p>
                </div>
              ))}
            </div>
          </div>
