          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="pt-8 pb-4 px-6">
                <span 
                  className={`font-display text-6xl lg:text-7xl font-light text-rose-gold ${
                    isVisible 
                      ? index === 0 ? 'animate-text-glow-0' 
                        : index === 1 ? 'animate-text-glow-1'
                        : index === 2 ? 'animate-text-glow-2'
                        : 'animate-text-glow-3'
                      : 'opacity-20'
                  }`}
                >
