  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-wave-0": {
          "0%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "8%": { filter: "drop-shadow(0 0 30px rgba(183, 110, 121, 0.9))", opacity: "1" },
          "17%": { filter: "drop-shadow(0 0 30px rgba(183, 110, 121, 0.9))", opacity: "1" },
          "25%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "100%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
        },
        "glow-wave-1": {
          "0%, 12.5%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "20.5%": { filter: "drop-shadow(0 0 30px rgba(183, 110, 121, 0.9))", opacity: "1" },
          "29.5%": { filter: "drop-shadow(0 0 30px rgba(183, 110, 121, 0.9))", opacity: "1" },
          "37.5%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "100%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
        },
        "glow-wave-2": {
          "0%, 25%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "33%": { filter: "drop-shadow(0 0 30px rgba(183, 110, 121, 0.9))", opacity: "1" },
          "42%": { filter: "drop-shadow(0 0 30px rgba(183, 110, 121, 0.9))", opacity: "1" },
          "50%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "100%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
        },
        "glow-wave-3": {
          "0%, 37.5%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "45.5%": { filter: "drop-shadow(0 0 30px rgba(183, 110, 121, 0.9))", opacity: "1" },
          "54.5%": { filter: "drop-shadow(0 0 30px rgba(183, 110, 121, 0.9))", opacity: "1" },
          "62.5%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "100%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
        },
      },
      animation: {
