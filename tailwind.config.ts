    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-wave-0": {
          ...
          "15%": { filter: "drop-shadow(0 0 30px rgba(183, 110, 121, 0.9))", opacity: "1" },
          "20%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
        ...
        "glow-wave-1": {
          ...
          "40%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "100%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
        },
        "glow-wave-2": {
          "0%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "40%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "45%": { filter: "drop-shadow(0 0 30px rgba(183, 110, 121, 0.9))", opacity: "1" },
          "55%": { filter: "drop-shadow(0 0 30px rgba(183, 110, 121, 0.9))", opacity: "1" },
          "60%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "100%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
        },
        "glow-wave-3": {
          "0%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "60%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "65%": { filter: "drop-shadow(0 0 30px rgba(183, 110, 121, 0.9))", opacity: "1" },
          "75%": { filter: "drop-shadow(0 0 30px rgba(183, 110, 121, 0.9))", opacity: "1" },
          "80%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
          "100%": { filter: "drop-shadow(0 0 8px rgba(183, 110, 121, 0.3))", opacity: "0.7" },
        },
      },
      animation: {
